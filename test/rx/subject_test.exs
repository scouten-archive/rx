defmodule Rx.SubjectTest do
  ...
  test "should be able to accept values and pump them through" do
    subject = Rx.Subject.create()

    Rx.Subject.next(subject, "foo")
    Rx.Subject.next(subject, "bar")
    Rx.Subject.done(subject)
    ...
    assert notifs == [{:next, "foo"}, {:next, "bar"}, :done]
  end

  # test "should pump values to multiple subscribers" do
  #   subject = %Rx.Subject{id: make_ref()}
  #
